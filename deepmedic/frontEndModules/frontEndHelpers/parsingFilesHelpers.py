...
def getAbsPathEvenIfRelativeIsGiven(pathGiven, absolutePathToWhereRelativePathRelatesTo) :
	...
	if os.path.isabs(pathGiven) : 
		...
		if os.path.isdir(absolutePathToWhereRelativePathRelatesTo) :
			...
			print("ERROR: in [func:returnAbsolutePathEvenIfRelativePathIsGiven()] Given path :", absolutePathToWhereRelativePathRelatesTo, " does not correspond to neither an existing file nor a directory. Exiting!")
			exit(1)
