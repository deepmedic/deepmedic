...
class ModelConfig(Config):
    ...
    MODEL_NAME = \
        config_data.add_elem("modelName", elem_type='String',
    ...
    NUM_INPUT_CHANS = \
        config_data.add_elem("numberOfInputChannels", required=True,
    ...
    N_FMS_NORM = \
        config_data.add_elem("numberFMsPerLayerNormal", required=True,
    ...
    KERN_DIM_NORM =\
        config_data.add_elem("kernelDimPerLayerNormal", required=True, description='Kernel Dimensions per Layer',
                             info="This list should have as many entries as the number of layers in "
                                  "the normal pathway.\n"
    ...
    RESID_CONN_LAYERS_NORM = \
        config_data.add_elem("layersWithResidualConnNormal", required=False,
                             ...
                             info="List with number of layers, at the output of which to make a "
                                  ...
                                  "Ala Kaiming He et al, \"Deep Residual Learning for Image Recognition\".\n"
    ...
    LOWER_RANK_LAYERS_NORM = \
        config_data.add_elem("lowerRankLayersNormal", required=False, description='Lower Rank Layers',
    ...
    USE_SUBSAMPLED = \
        config_data.add_elem("useSubsampledPathway", elem_type='Bool', widget_type='checkbox',
                             description='Use Subsampled Pathway',
                             info="Specify whether to use a subsampled pathway. If False, all subsampled-related "
                                  "parameters will be read but disregarded in the model-construction.",
                             default=False)
    ...
    N_FMS_SUBS = \
        config_data.add_elem("numberFMsPerLayerSubsampled", parent=USE_SUBSAMPLED,
                             description='Num. of Feature Maps per Layer',
                             info="This list should have as many entries as the number of layers in "
                                  ...
                                  "of Rec.Field.")
    KERN_DIM_SUBS = \
        config_data.add_elem("kernelDimPerLayerSubsampled", parent=USE_SUBSAMPLED,
    ...
    SUBS_FACTOR = \
        config_data.add_elem("subsampleFactor", parent=USE_SUBSAMPLED,
                             ...
                             default=[[3, 3, 3]])
    RESID_CONN_LAYERS_SUBS = \
        config_data.add_elem("layersWithResidualConnSubsampled", parent=USE_SUBSAMPLED,
                             description='Layers with Residual Connections',
                             info="List with number of layers, at the output of which to make a "
                                  "residual connection with the input of the previous layer. "
                                  "Ala Kaiming He et al, \"Deep Residual Learning for Image Recognition\".\n"
    ...
    LOWER_RANK_LAYERS_SUBS = \
        config_data.add_elem("lowerRankLayersSubsampled", parent=USE_SUBSAMPLED, description='Lower Rank Layers',
                             info="Layers to make of lower rank. Ala Yani Ioannou et al, "
                                  "\"Training CNNs with Low-Rank Filters For Efficient Image Classification\".\n"
                                  "Example: [3,5] will make the 3rd and 5th layers of lower rank.\n"
    ...
    N_FMS_FC = \
        config_data.add_elem("numberFMsPerLayerFC", description='Num. of Feature Maps per Layer',
    ...
    SEG_DIM_TRAIN = \
        config_data.add_elem("segmentsDimTrain", required=True,
    ...
    SEG_DIM_VAL = \
        config_data.add_elem("segmentsDimVal", description='Validation Segments Dimensions',
                             info="DeepMedic does not process patches of the image, but larger "
    ...
    SEG_DIM_INFER = \
        config_data.add_elem("segmentsDimInference",
    ...
    DROP_NORM = \
        config_data.add_elem("dropoutRatesNormal", description='Normal Pathway Dropout Rates',
                             ...
                             default=[])
    DROP_SUBS = \
        config_data.add_elem("dropoutRatesSubsampled", description='Subsampled Pathway Dropout Rates',
                             info="Dropout Rates on the input connections of the various layers. Each list "
                             ...
                             default=[])
    DROP_FC = \
        config_data.add_elem("dropoutRatesFc", description='FC Layers Dropout Rates',
                             info="Dropout Rates on the input connections of the various layers. Each list "
    ...
    CONV_W_INIT = \
        config_data.add_elem("convWeightsInit", elem_type='Conv_w', widget_type='conv_w',
                             ...
                             options={'fanIn': ConfigElem("init_scale",
                                                          ...
                                                          info="scale for scaling variance with (scale/fanIn)",
                                                          default=2),
                                      "normal": ConfigElem("init_std",
                                                           description='Initialisation Standard Deviation',
                                                           info="Standard deviation for sampling from N(0, std)")})
    # Activation Function for all convolutional layers:
    ACTIV_FUNC = \
        config_data.add_elem("activationFunction", elem_type='String', widget_type='combobox',
    ...
    # Batch Normalization
    BN_ROLL_AV_BATCHES = \
        config_data.add_elem("rollAverageForBNOverThatManyBatches",
                             description='Num. Batches for Batch Norm Rolling Average',
                             info="Batch Normalization uses a rolling average of the mus and std for inference.\n"
