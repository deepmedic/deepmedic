...
class TestConfig(Config):
    ...
    DATAFRAME = \
        config_data.add_elem("dataframe", elem_type='File', description="Input DataFrame",
    ...
    CHANNELS = \
        config_data.add_elem("channels", description="Input Channels", elem_type='Files',
    ...
    FNAMES_PREDS = \
        config_data.add_elem("namesForPredictionsPerCase", elem_type='File',
