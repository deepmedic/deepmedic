...
class Ui_DeepMedic2(object):
    def setupUi(self, DeepMedic2):
        ...
        self.gridLayout.addWidget(self.run_button, 14, 0, 1, 4)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout.addWidget(self.output_log, 15, 0, 1, 4)
    ...
    def retranslateUi(self, DeepMedic2):
        ...
        self.device_combobox.setItemText(2, QtWidgets.QApplication.translate("DeepMedic2", "CPU", None, -1))
        self.device_combobox.setItemText(3, QtWidgets.QApplication.translate("DeepMedic2", "GPU", None, -1))
        ...
        self.run_button.setText(QtWidgets.QApplication.translate("DeepMedic2", "Run DeepMedic", None, -1))
